...
public class MusicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(0, R.raw.classical);
        songs.add(1, R.raw.easylifestyle);
        songs.add(2, R.raw.relaxed);
        songs.add(3, R.raw.smoke);
        songs.add(4,R.raw.relaxing);
    ...
    private void songNames() {
        if (currentIndex == 0) {
            songTitle.setText("Ambient Classical Guitar - William King");
            imageView.setImageResource(R.drawable.goblin);
        }
        if (currentIndex == 1) {
            songTitle.setText("Easy life style -Dil ");
            imageView.setImageResource(R.drawable.zindagi);
        }
        if (currentIndex == 2) {
            songTitle.setText("Relaxed-Iktara ");
            imageView.setImageResource(R.drawable.wake);
        }
        if (currentIndex == 3) {
            songTitle.setText("relaxing - classic");
            imageView.setImageResource(R.drawable.gaho);
        }
        if (currentIndex == 4) {
            songTitle.setText("Start Over");
